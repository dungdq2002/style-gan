...
class CASTModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netAE = net.StyTr_Encoder(
            vgg,
            net.Decoder(self.gpu_ids),
            networks.PatchEmbed(),
    ...
    def optimize_parameters(self):
        ...
        if self.opt.lambda_GAN_D_A > 0.0 or self.opt.lambda_GAN_D_B > 0.0:
            ...
            self.set_requires_grad(
                [self.netD, self.netP_style, self.netAE, self.netDec_A, self.netDec_B],
                False,
            )
        ...
        if self.opt.lambda_NCE_D > 0.0:
            ...
            self.set_requires_grad(
                [self.netAE, self.netDec_A, self.netDec_B, self.netD_A, self.netD_B],
                False,
            )
